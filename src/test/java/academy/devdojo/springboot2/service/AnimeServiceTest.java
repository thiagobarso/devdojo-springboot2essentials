...
class AnimeServiceTest {
    ...
    @Test
    @DisplayName("findByIdOrThrowBadRequestException throws BasRequestException when anime is not found")
    void findByIdOrThrowBadRequestException_ThrowsBasRequestException_WhenAnimeIsNotFound() {
        BDDMockito.when(animeRepositoryMock.findById(ArgumentMatchers.anyLong()))
